...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const fire = document.querySelector('#flame') as HTMLElement;
  ...
  //add numbers
    ...
    function click(square: HTMLDivElement) {
    ...
    function gameOver(square: HTMLDivElement) {
    ...
    function checkSquare(square: HTMLDivElement, currentId: string) {
    ...
    const tank = document.querySelector('.tankTest') as HTMLElement;
